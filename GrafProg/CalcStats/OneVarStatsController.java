...
public class OneVarStatsController {
    ...
    public void initialize(){
        columnComboBox.setItems(FXCollections.observableArrayList(TableHeaderActions.getHeaderArrayCdr(TableUI.getData())));
    ...
    public void pullDownMoused(MouseEvent mouseEvent) {
      // functionComboBox.setSelectionModel(FXCollections.observableArrayList(GrafProg.GrafProg.getData().getHeaderArray());
        // setModel(new javax.swing.DefaultComboBoxModel(GrafProg.GrafProg.getData().getHeaderArray()));
        //System.out.println("Headers:"+GrafProg.GrafProg.getData().getHeaderArray()[3]);

        columnComboBox.setItems(FXCollections.observableArrayList(TableHeaderActions.getHeaderArrayCdr(TableUI.getData())));
                //= new ComboBox(FXCollections.observableArrayList(GrafProg.GrafProg.getData().getHeaderArray()));
    }
