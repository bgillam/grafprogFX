...
import GrafProg.CalcStats.FrequencyChartDialog;
import GrafProg.CalcStats.RegressionDialog;
...
/*    @FXML    private void exitApplicaton(ActionEvent ae){
    ...
    public void onFxInput(ActionEvent actionEvent) {
       ...
       //GrafProg.GrafProg.getDialogController().showFxEntryDialog();
           ...
           Platform.runLater(() -> {
               ...
               if (objectList.size() > 1) {
                   ...
                   chosenObject.autoRange();
                    ...
                    noObjects.setTitle("No GrafProg.GrafProg.GrafObjects!");
                    noObjects.setHeaderText("No GrafProg.GrafProg.GrafObjects have been created. \nCan't AutoRange.");
                    noObjects.showAndWait();
               }

           });

        //GrafProg.GrafUtils.Scales.autoRange(GrafProg.GrafProg.getGrafSettings(), );
            }
