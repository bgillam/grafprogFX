...
/**************************************** 
*  GrafProg.GrafUI.WindowSizeDialog  for GrafProg.GrafProg Project
...
{   
    ...
    private JRadioButton setScale   = new JRadioButton("Input GrafProg.GrafUtils.Scales");
    ...
    private JLabel setScaleLabel = new JLabel("Set GrafProg.GrafUtils.Scales:");
    ...
    {   
        ...
        ////setLocationRelativeTo(GrafProg.GrafProg.getGrafPanel());
  ...
  public void actionPerformed(ActionEvent event) {
    ...
    if (event.getActionCommand().equals("Input GrafProg.GrafUtils.Scales")) { showScaleInput(); myScaleProcedure = GrafSettings.ScaleProcedure.SET_SCALES;}
...
//    else JOptionPane.showMessageDialog(null , "Range Entered is Invalid.", "ERROR!", JOptionPane.WARNING_MESSAGE);
  ...
  //Save everything to Plot.GrafProg.GrafUI.GrafSettings record
