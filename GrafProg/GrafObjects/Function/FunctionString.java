...
/* *************************************
* GrafProg.GrafObjects.Function.FunctionString for GrafProg.GrafProg Project *
...
//Class GrafProg.GrafObjects.Function.FunctionString
public class FunctionString {
    //given a string representing a function  and an input value, returns an output value
    public static double fValue(String fString, double x) { //throws GrafProg.GrafProg.GrafUtils.DomainViolationException, GrafProg.GrafObjects.Function.FunctionFormatException {
    ...
    static double eval(String fString){   // throws GrafProg.GrafProg.GrafUtils.DomainViolationException{
        int rp;
        ...
        if (fString.equals("domainError")) return Double.NaN; //throw new GrafProg.GrafProg.GrafUtils.DomainViolationException();
    ...
    public static void main(String[] args){
        ...
        try{
            ...
            //for (int i=0; i<8; i++) System.out.println(i+" "+GrafProg.GrafProg.GrafUtils.GrafInputHelpers.isAnAlphaChar(test,i));
