...
class FunctionStringOperators {
    ...
    private static String evalRightFunction(String token, String fString){  //} throws GrafProg.GrafProg.GrafUtils.DomainViolationException {
        ...
        do{
            ...
            //if (domainError) { throw new GrafProg.GrafProg.GrafUtils.DomainViolationException(); }
    ...
    static String rightFunctions(String fString){//} throws GrafProg.GrafProg.GrafUtils.DomainViolationException{
