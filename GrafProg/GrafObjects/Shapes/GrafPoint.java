...
public class GrafPoint extends GrafText implements IGrafable
{
   ...
   public GrafPoint(){
       super();
       //gStuff = super.initGrafObject(GrafProg.GrafObjects.GrafType.POINT);
   ...
   public String toString(){
    ...
    /*private static void savePoint(GrafProg.GrafProg gSess, GrafInputDialog gfd){
    ...
    /*private static void addPoint(GrafProg.GrafProg gSess, GrafInputDialog gfd){
       ...
       GrafProg.GrafObjects.Shapes.GrafPoint gPlot = new GrafProg.GrafObjects.Shapes.GrafPoint(gfd.getPointPanel().getX1(), gfd.getPointPanel().getY1(), gfd.getMark(), gfd.getMarkChooser().getColor());
