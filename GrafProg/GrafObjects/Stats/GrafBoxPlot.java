...
/*  GrafBoxplot for GrafProg.GrafProg Project *
...
public class GrafBoxPlot extends GrafObject implements IGrafable {
    ...
    public static int numBoxPlots = 0;
    ...
    //drawG   raf overriding method in parent GrafProg.GrafObjects.GrafObject
    @Override
    public void drawGraf(Graphics2D gc){
       ...
       //Plot.GrafProg.GrafPrimitives.grafString(table.getCellValue(i, columnNumber), i , mark, gc);
        else{
            ...
            //Plot.GrafProg.GrafPrimitives.grafLine(gStuff,GrafProg.CalcStats.GrafStats.getMin(table.getColumnValues(columnNumber)), , x2, y2, gc);
    ...
    /*private static GrafProg.GrafProg.GrafTable getData(){
        return GrafProg.GrafTable.TableUI.getData();
    }*/
