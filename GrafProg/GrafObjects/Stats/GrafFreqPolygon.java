...
public class GrafFreqPolygon extends GrafHistogram implements IGrafable {
        ...
        public boolean isValidInput(GrafProg.GrafObjects.Dialog.GrafDialogController gdf){
            if (!GrafProg.GrafProg.GrafUtils.GrafInputHelpers.isDouble(gdf.getX1())) {
                GrafProg.GrafProg.GrafUtils.GrafInputHelpers.setTextFieldColor(gdf.getX1TextField(), "red");
                return false;}
            if (!GrafProg.GrafProg.GrafUtils.GrafInputHelpers.isDouble(gdf.getX2())) {
                GrafProg.GrafProg.GrafUtils.GrafInputHelpers.setTextFieldColor(gdf.getX2TextField(), "red");
                return false;}
            if (gdf.getClassSizeButton().isSelected() && !GrafProg.GrafProg.GrafUtils.GrafInputHelpers.isDouble(gdf.getClassWidthText())) {
        ...
        *//*if (gdf.getNumClassButton().isSelected() && !GrafProg.GrafProg.GrafUtils.GrafInputHelpers.isAnInteger(gdf.getNumClasses())) {
        ...
        public boolean deepEquals(GrafProg.GrafObjects.GrafObject o){
            GrafProg.GrafObjects.Stats.GrafHistogram gh = (GrafProg.GrafObjects.Stats.GrafHistogram) o;
