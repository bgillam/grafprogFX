package GrafProg.GrafObjects.Dialog; /****************************************
 GrafProg.GrafObjects.Dialog.GrafDialogView
 This class implements changes in the active GrafDialog
 All calls to this classes static methods should come through GrafProg.GrafObjects.Dialog.GrafDialogController
 2-20-2020
 Bill Gillam
 */
...
import GrafProg.GrafObjects.Function.*;
import GrafProg.GrafObjects.GrafObject;
import GrafProg.GrafObjects.GrafType;
import GrafProg.GrafObjects.Shapes.*;
import GrafProg.GrafObjects.Stats.*;
import GrafProg.GrafProg;
import GrafProg.GrafTable.TableColumnActions;
import GrafProg.GrafTable.TableHeaderActions;
...
public class GrafDialogView {
    ...
    //private GrafProg.GrafObjects.GrafType gType;
    ...
    private static void showColumnChooser(){
        ...
        //fComboBox.setItems(FXCollections.observableArrayList(GrafProg.GrafTable.TableHeaderActions.getHeaderArrayCdr(GrafProg.GrafProg.getData())));
    ...
    static ArrayList<GrafObject> createObjectList(GrafType gtype){
        ...
        //return (GrafProg.GrafObjects.GrafObject[]) grafObjects.toArray();
        return grafObjects;
    }
   ...
   // }
    ...
    /*private void showFunctionString(boolean tf){
        GrafProg.GrafProg.getDialogController().showFunctionString(tf);
    }*/
    ...
    /*private String getFunctionChosen(){
        return GrafProg.GrafProg.getDialogController().functionChosen();
    }*/
