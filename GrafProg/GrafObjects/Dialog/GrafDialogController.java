package GrafProg.GrafObjects.Dialog;//package sample;
...
public class GrafDialogController {
    ...
    private void onCreateButtonClicked(ActionEvent e){
            addGrafObject();
            resetObjectList();
            //objectComboBox.setItems(FXCollections.observableArrayList(GrafProg.GrafObjects.Dialog.GrafDialogView.createObjectList(GrafProg.GrafObjects.Dialog.GrafDialogView.getGrafType())));
    }
    ...
    private void onEditButtonClicked(ActionEvent e){
        ...
        try {
            ...
            getGrafColorPicker().setValue(currentObject.getFXColor());

            currentObject.loadObjectFields(this);

        }catch (Exception Empty){
            GrafDialogView.setMessage("No GrafProg.GrafObjects.GrafObject chosen");
        }
   ...
   /* public GrafProg.GrafProg.GrafTable getData(){
