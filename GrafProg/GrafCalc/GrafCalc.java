		...
		}
		{
			...
			{   //copies highlighted textg
				...
				btnCopy.addActionListener(arg0 -> {
                    if (mathTextSelected) clipper.setClipboardContents(textField.getSelectedText());   // GrafProg.GrafProg.setCopiedText(textField.getSelectedText());
                    else if (ansTextSelected) clipper.setClipboardContents(textField_1.getSelectedText());     //GrafProg.GrafProg.setCopiedText(textField_1.getSelectedText());
                    else if (xTextSelected) clipper.setClipboardContents(textField_2.getSelectedText());     //GrafProg.GrafProg.setCopiedText(textField_2.getSelectedText());
		...
		}
		{
			...
			}
			{
				...
				btnPaste.addActionListener(arg0 -> {
                    ...
                    toBePastedInto.setText(toBePastedInto.getText().substring(0,pos)+clipper.getClipboardContents()+toBePastedInto.getText().substring(pos));   //textField.getText().substring(0,pos)+GrafProg.GrafProg.getCopiedText()+textField.getText().substring(pos,textField.getText().length()));
