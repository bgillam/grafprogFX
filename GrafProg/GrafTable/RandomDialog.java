...
*  GrafProg.GrafTable.RandomDialog for GrafProg.GrafProg Project *
*  Dialog to generate random values in 
*  GrafProg.GrafProg.GrafProg.GrafTable.GrafTable column
*  @author Bill Gillam                   *
*  2/25/15                               *
*****************************************/
...
public class RandomDialog extends JDialog {
    ...
    public void showDialog(){
		...
		setVisible(true);	
    	//setModal(true);
		//GrafProg.GrafProg.getTableStage().isAlwaysOnTop();
