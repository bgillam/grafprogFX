 ...
 * product(Matrix A, Vector B)
 * product(Vector A, Matrix B)
 * copy()
...
public class Matrix {
    ...
    public static void main(String args[]){
      ...
      //       {1,6}};
       ...
       //Matrix mTxm = Matrix.product(mT,m);
       ...
       //System.out.println("Matrix mTxm: ");
       //System.out.println(mTxm);
       //Matrix inv = mTxm.inverse();
   ...
   //public static Matrix fromArray(BigDecimal[][] a){
